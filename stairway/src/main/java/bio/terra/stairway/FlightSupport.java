 ...
 *
 * <p>This interface provides additional methods for the {@link Flight} implementation. It lets us
 * better separate the internal implementation of flights and the Stairway object rather than have
 * them as public members referenced directly from the Flight object.
 */
public interface FlightSupport {
  ...
  // Flight completion
  void exitFlight(FlightContext flightContext) throws StairwayException, InterruptedException;

  // Step completion
  void recordStep(FlightContext flightContext) throws StairwayException, InterruptedException;

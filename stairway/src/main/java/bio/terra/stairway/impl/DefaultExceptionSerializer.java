...
/**
 * This is the default implementation of ExceptionSerializer. It is used to convert to and from
 * exceptions. It accepts an Exception in and saves the class name and message. It accepts name and
 * message and carefully generates an exception result.
 *
 * <p>The following requirements must be met to generate an exception from the name and message:
 *
 * <ol>
 *   <li>The exception class must exist
 *   <li>The exception class must be a RuntimeException
 *   <li>The exception must have a constructor accepting a single string argument
 * </ol>
 *
 * If those requirements are not met, then we generate the UnmappableException to hold the class
 * name string and message string.
 */

...
public class TestStepForLoopUndo implements Step {
    ...
    public StepResult doStep(FlightContext context) throws InterruptedException {
        ...
        if (stopCounter == currentCounter) {
            ...
            return new StepResult(StepStatus.STEP_RESULT_FAILURE_FATAL, new IllegalStateException("Error!"));
        } else {
    ...
    public StepResult undoStep(FlightContext context) {
        ...
        // Do processing for current counter
        logger.debug("Undo for " + startCounter + " to " + endCounter + " processing at " + currentCounter);

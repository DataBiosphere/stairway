...
/**
 * Step result objects are returned from the do() and undo() methods of a step. The step status lets
 * the Flight code know whether to continue forward, go backward, or retry the step.
 */
public class StepResult {
  ...
  // NOTE: This constructor is used in the DAO when deserializing the exception; we don't want to
  // re-log it
  ...
  public boolean isSuccess() {
    return (stepStatus == StepStatus.STEP_RESULT_SUCCESS
        ...
        || stepStatus == StepStatus.STEP_RESULT_RESTART_FLIGHT);
  }

...
/**
 * DatabaseSetupException indicates that something is wrong with the database environment. We were
 * not able to create or reset or recover the database. This is fatal for stairway.
 */

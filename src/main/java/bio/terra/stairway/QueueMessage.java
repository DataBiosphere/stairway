...
public abstract class QueueMessage {
    ...
    public static Boolean processMessage(String message, Stairway stairway) throws InterruptedException {
    ...
    public static QueueMessage deserialize(String message) {
        ...
        try {
            ...
            logger.error("Ignoring message: failed to deserialize type: " + queueMessageEnum.name() +
                    " message: " + message);
            return null;
        }
    }
